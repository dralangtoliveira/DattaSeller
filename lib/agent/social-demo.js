...
export function buildSocialDemo({ lead = {}, analysis = null, brand = {}, texts = {}, contacts = {}, diagnosis = null, now = () => new Date() } = {}) {
  ...
  const feed_pieces = pecas.map((peca) => ({
    id: peca.id,
    format: peca.formato,
    hook: clean(peca.hook),
    caption: clean(peca.caption),
    ...
    source_note: "Copy montada apenas com elementos reais do cliente (headline, serviços, endereço, contato, fotos).",
  }));
